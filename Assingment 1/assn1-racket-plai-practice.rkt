...
(define-type OE
  ...
  [arrive (expr1 OE?)]
  [name (expr1 OE?) (id symbol?) (expr2 OE?)]
...
; Subproblem 1: "(ab)|c"
(define reparse1 "regexp,regexp,pces,pce,atom,regexp,pces,pce,atom,literal,pces,pce,atom,literal,pces,pces,regexp,pces,pce,atom,literal,pces")
...
; Subproblem 2: "(ab)|"
(define reparse2 "regexp,regexp,pces,pce,atom,regexp,pces,pce,atom,literal,pces,pce,atom,literal,pces,pces,regexp,pces")

; Subproblem 3: "+*"
(define reparse3 "")

; Subproblem 4: "[]a]"
(define reparse4 "regexp,pces,pce,atom,rng,mrng,lrng,lirng,riliteral,pces")

; Subproblem 5: ".??"
(define reparse5 "regexp,pces,pce,repeat,atom,pces")
